...
public class PinUpdateLiveData extends LiveData<Map<String, PinData>> {
    private static final String TAG = "PinUpdateLiveData";
    private final DatabaseReference db;
    private final Map<String, PinData> mp;
